export default function Services() {
  return (
    <div id='services' className="bg-blue-100e  text-white relative">
      ...
      <div className="w-screen/2 px-8 mx-auto grid flex-col justify-items-stretch">
        <div className="mb-32 justify-self-start">
          <h1 className="text-blue-400 text-3xl"> Physical Surveys: </h1>
          <p className="w-96 text-3xl  text-left mx-auto ">
        ...
        <div className="my-32 justify-self-start">
          <p className="w-96 text-3xl  text-left mx-auto ">
            <span className="text-blue-400 text-3xl ">Company Flush: </span>a
        ...
        <div className="my-32 justify-self-end">
          <p className="w-96 text-3xl text-left mx-auto ">
            <span className="text-blue-400 text-3xl ">Investigations: </span>
